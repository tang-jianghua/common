...
public class EncryptDemo4 {
	...
	public static void main(String[] args) throws Exception {
		...
		String sn = "869632030184121";
		String simId = "898604061918c0659661";
...
//		String wk = keyCreate(24);
		String pk = "tP9PWf3zZjjMXC6m7FstuqGp";
		String wk = "6HK3D0P1Hd0MOAuWy3vWfjgZ";
		...
		String key1 = calSignHex.substring(0, 24);
		A = Des3Util.encryptStr(key1,key);
