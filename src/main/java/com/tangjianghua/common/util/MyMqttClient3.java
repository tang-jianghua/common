...
public class MyMqttClient3 implements Runnable{
...
//	public static final String HOST = "tcp://39.97.168.28:1883";
	...
	public MyMqttClient3(String topic, String clientid) {
		this.topic = topic;
...
//		for (int i = 0; i < 30; i++) {
			Thread thread = new Thread(new MyMqttClient3("tangjianghua","tangjianghua"));
			thread.start();
//		}
	}
}
